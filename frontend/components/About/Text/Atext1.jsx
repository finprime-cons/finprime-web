...
const Atext1 = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between text-xs sm:text-sm md:text-[16px] tracking-[1px]">
          <button className="flex-1 px-3 py-4 overflow-hidden whitespace-nowrap
            ...
            <span className="absolute right-0 w-10 h-32 -mt-12 transition-all duration-1000 
              transform translate-x-12 bg-white opacity-5 rotate-12 group-hover:-translate-x-[500px] ease"></span>
            Giving smartness to your business accounting
          </button>

          <button className="flex-1 px-3 py-4 overflow-hidden whitespace-nowrap
            group bg-black relative 
            transition-all duration-300 uppercase text-white border-t sm:border-t-0 sm:border-l border-white hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 ease-out">
            <span className="absolute right-0 w-10 h-32 -mt-12 transition-all duration-1000 
              transform translate-x-12 bg-white opacity-5 rotate-12 group-hover:-translate-x-[500px] ease"></span>
          ...
          <button className="flex-1 px-3 py-4 overflow-hidden whitespace-nowrap
            ...
            text-white border-t sm:border-t-0 sm:border-l border-white hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500">
            <span className="absolute right-0 w-10 h-32 -mt-12 transition-all duration-1000 
              transform translate-x-12 bg-white opacity-5 rotate-12 group-hover:-translate-x-[500px] ease"></span>
