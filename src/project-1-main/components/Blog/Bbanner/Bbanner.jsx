...
const Bbanner = () => {
  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden">
      ...
      {/* Content overlay */}
      <div className="absolute top-0 left-0 pt-60 xl:pl-12 lg:pl-10 md:pl-8 pl-6 pr-4 sm:pr-0 text-white ">
        <h4 className="text-4xl sm:text-4xl font-medium mb-6 animate-fadeinleft ">
          Blog
        </h4>
        <p className="animate-fadeinbottom text-xs sm:text-[16px] tracking-[1px] font-raleway mb-2">
          This is a long paraexpand on this with multiple lines of text to make
          it more informative.
        </p>
        <p className="mb-6 animate-fadeinbottom text-xs sm:text-[16px] tracking-[1px] font-raleway">
          underneath the heading. It can describe something important
        </p>
      ...
      <div className="absolute bottom-8 xl:left-12 lg:left-10 md:left-8 left-6 w-7/10 border-t border-white w-[60%] sm:w-[70%]">
        ...
        <div className="flex items-center space-x-4 sm:space-x-8 text-white animate-fadeinleft">
          ...
          <div className="flex flex-col items-center">
            <Link
              to="/"
              className="  text-[12px] sm:text-[18px] tracking-[1px] font-medium font-raleway"
            >
              Home
            </Link>
          </div>
      ...
      <div className="absolute bottom-4 sm:bottom-10 xl:right-10 lg:right-8 md:right-6 right-4 animate-fadeinright">
        ...
        >
          {isPlaying ? (
            <FaPause className="text-lg sm:text-2xl" />
          ) : (
