...
const Servicesection5 = () => {
  ...
  return (
    ...
    >
      <div>
        <h4 className="text-lg text-white md:text-3xl lg:text-4xl pb-2 font-bold">
          Direct Your Inbox
        </h4>
        <p className="text-xs text-white tracking-[1px] font-raleway sm:text-[16px]">
      ...
      <div>
        <Link
          ...
          className="bg-transparent text-xs md:text-[16px] tracking-[1px] text-white border border-white font-semibold py-2 sm:py-3 font-raleway px-3 sm:px-10 transition-all duration-300 
