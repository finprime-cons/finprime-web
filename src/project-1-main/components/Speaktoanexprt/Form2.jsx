  ...
  useEffect(() => {
    if (subServiceId) {
      const selectedSubService = subServices.find(
        (sub) => sub.subid === parseInt(subServiceId)
      );
    ...
    >
      ...
      <div className="max-w-2xl mx-5 sm:mx-auto top-20  border pb-10  p-8 bg-brandBlue shadow-lg rounded-lg relative">
        <img
          src={img1}
          alt="Logo"
          className="h-20 sm:h-32 lg:h-20 mx-auto mb-12 mt-5"
        />
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex mt-10 mb-6 items-center">
            ...
            <label
              ...
              className="ml-1 block text-[13px] xs:text-sm
               text-gray-500"
            >
