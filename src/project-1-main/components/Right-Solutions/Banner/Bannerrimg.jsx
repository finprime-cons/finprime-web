...
const Bannerrimg = () => {
  ...
  const cardData = [
    {
      image: america,
      title: "United States of Amarica",
      description:
        "Income taxes, payroll taxes, state and local sales taxes, federal and state excise taxes, and local property taxes.",
    },
    {
      image: uk,
    ...
    },
    {
      ...
      description:
        "However, it levies 5 per cent value added Tax on the purchase of goods and services,",
    },
  ];
  ...
  return (
    ...
    >
      <div className=" w-full text-white text-center pt-36 pb-28">
        ...
        >
          <h3 className="text-2xl  sm:text-4xl md:text-6xl lg:text-7xl  xl:text-8xl font-light">
            YOUR <span className="font-bold">PROJECT</span>
          </h3>
          <h3 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl  xl:text-8xl font-light">
            FINANCE <span className="font-bold">TO</span> PROGRESS
          </h3>
          <h3 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl  xl:text-8xl font-light">
            SIMPLE <span className="font-bold">SHORT</span> TERM
          </h3>
        </div>
      </div>
      ...
      >
        {cardData.map((card, index) => (
         ...
         ${
           hoveredIndex === index
             ? "bg-black  bg-opacity-60 backdrop-blur-md transition-all duration-500 "
             : "bg-transparent"
         }`}
          >
            ...
            <h4 className="text-xs sm:text-xs md:text-[15px] lg:text-xl xl:text-3xl font-semibold pt-7">
              {card.title}
            ...
            <button
              className={` border-2  px-4 py-2 text-[10px] md:text-md
             ${
               hoveredIndex === index
                 ? "bg-white text-black"
