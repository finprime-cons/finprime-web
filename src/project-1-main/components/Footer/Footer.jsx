...
import comapanyProfilePdf from "../../assets/pdf/finprime comapny profile final.pdf";
    ...
    <div className="pt-10 pl-6 pr-4 text-white bg-black xl:pl-12 xl:pr-10 lg:pl-10 lg:pr-8 md:pl-8 md:pr-6 sm:pt-10 ">
      <div className={`  `}>
        ...
        <div className="flex flex-col w-full pt-4 pb-4 lg:flex-row  lg:mx-0">
          <div className="bg-white relative w-full lg:w-[30vw]">
            <img
              ...
              <div className="w-full bg-white">
                ...
                >
                  ...
                  <div className="lg:flex  ">
                    ...
                    <div
                      className="flex flex-col justify-between   items-center sm:items-center md:items-center lg:items-start"
                      style={{
                        marginTop: "90px",
                        marginLeft: "20px",
                        marginRight: "20px",
        ...
        <div className="flex flex-col w-full pt-4 pb-6 sm:flex-row">
          <div className="w-full py-4 sm:w-1/3">
            <h4 className="pb-5 text-lg font-semibold lg:text-xl font-khula sm:pb-4">
              Quick Links
            </h4>
            <ul className="mt-2 space-y-2 text-sm lg:text-md font-raleway sm:space-y-4">
              <li>
                ...
                <Link
                  to="/"
                  className="pb-2 text-white font-raleway hover:text-cyan-500 hover-underline-animation1"
                >
                  {" "}
                  Home
                </Link>
          ...
          <div className="w-full py-4 sm:w-1/3 sm:p-4">
            ...
            <ul className="mt-2 space-y-2 text-sm lg:text-md sm:space-y-4">
              <li className="font-raleway">
                Suite 1203, Floor 12A, DAMAC Executive Bay, Business Bay, Dubai,
                UAE
              </li>
              <li className="font-raleway">Phone: +971 58 259 3543</li>
              <li className="font-raleway ">
                Email: info@finprimeconsulting.com
              </li>
              <li className="flex pt-5 mt-2 space-x-3">
                <div className="flex space-x-1 lg:space-x-2 bg-white bg-opacity-55 rounded-[5px] border border-opacity-20 p-1 lg:p-3 mb-[24px] sm:mb-0 ">
                  <button
                    className=" hidden xl:block  pl-4 pr-4 rounded-sm   shadow-black  text-[16px] tracking-[1px]
