...
const Servicecard = () => {
  ...
  return (
    ...
    >
      ...
      <div
        id="footerservices"
        className="absolute left-0 right-0 z-30 flex justify-center top-10 sm:top-16 sm:pl-6 md:pl-8 lg:pl-10 xl:pl-12 sm:justify-start"
      >
      ...
      >
        {Services.map((service, index) => (
          <SwiperSlide
            ...
            ${
              index === activeIndex ? "bg-brandBlue bg-opacity-40" : ""
            }  // Active item background
            ${
              index !== activeIndex
                ? "hover:bg-brandBlue hover:bg-opacity-40"
                : ""
