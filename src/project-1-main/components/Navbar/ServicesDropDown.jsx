      ...
      <div className="flex flex-col w-full h-full md:flex-row">
        ...
        <div className="flex flex-col py-16 px-4 md:px-14 w-full md:w-[20%]">
          ...
          <p className="text-sm text-left text-gray-600 font-raleway">
            Our accounting services ensure your business complies with
            regulations and maintains financial health.
          </p>
          <button
        ...
        {/* Column 3: Answers or Placeholder */}
                  ...
                  <li key={sub.subid}>
                    <Link
                      to={`/services/${services[
                        selectedIndexOpen
                      ].title.replace(/\s+/g, "-")}/${sub.keyword.replace(
                        /\s+/g,
                        "-"
                      )}`}
                      state={{
