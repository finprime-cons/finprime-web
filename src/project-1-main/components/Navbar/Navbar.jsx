                  ...
                  <div className="flex flex-col w-full h-full md:flex-row">
                    <div className="flex flex-col py-16 px-4 md:px-14 w-full  md:w-[20%]">
                      ...
                      <p className="text-sm text-left text-gray-600 font-raleway">
                        Our accounting services ensure your business complies
                        with regulations and maintains financial health.
                      </p>
                      <button
                    ...
                    <div className="flex flex-col w-full md:w-[40%] h-full relative">
                      {selectedIndexOpen !== null && isAnswerVisible ? (
                        <div
                          className={`inset-0 w-full h-[445px] transition-opacity duration-500 ease-in-out animate-fadeinleftsmall bg-brandBlue px-4 md:px-28 py-4`}
                        >
                          ...
                          <ul>
                            {Services[selectedIndexOpen].subtitles.map(
                              (sub) => (
                                <li key={sub.subid}>
                                  <Link
                        ...
                        <ul className="px-4 py-4 text-black md:px-28 md:py-16">
                          <h4 className="font-semibold md:text-3xl font-khula">
                            Services
                          </h4>
                          {Services.map((index) => (
                            <p
