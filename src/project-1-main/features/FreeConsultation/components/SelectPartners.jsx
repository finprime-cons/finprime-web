...
const partners = [
  {
    ...
    name: "Databricks",
    icon: (
      <TbBrandDatabricks className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl" />
    ),
  },
  {
    id: 2,
    name: "AWS",
    icon: <FaAws className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl" />,
  },
  {
    id: 3,
    name: "Microsoft",
    icon: (
      <FaMicrosoft className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl" />
    ),
  },
  {
    id: 4,
    name: "Snowflake",
    icon: (
      <SiSnowflake className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl" />
    ),
  },
  {
    id: 5,
    name: "DBT",
    icon: <SiDbt className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl" />,
  },
];
...
const SelectPartners = () => {
  ...
  return (
    <div ref={fadeElementRef} className="mx-auto bg-black">
      <div
        className={`scale-y-125 scale-x-60 mx-10 xl:mr-10 xl:ml-12 lg:ml-10 ml-6  text-white pt-16 mb-8 ${
      ...
      <div
        className={`mt-10 xl:pl-12 lg:pl-10 md:pl-8 pl-6 pr-4 sm:pr-0 ${
          hasFadedIn ? "animate-fadeinbottom" : ""
        }`}
      >
        <h1 className="text-3xl sm:text-5xl lg:text-7xl text-white font-medium pb-20 ">
          Selected Partners{" "}
        </h1>
