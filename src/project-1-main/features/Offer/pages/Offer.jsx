...
const Offer = () => {
  ...
  const subService = service?.subtitles.find(
    (sub) => sub.subid === parseInt(sub.subid)
  );
    ...
    <HelmetProvider>
      <div>
        ...
        <div className="p-8 mt-40 mb-10 font-cinzel">
          {/* Big Heading */}
          <h4 className="px-5 text-3xl text-center md:px-20 lg:px-40 md:text-5xl xl:text-7xl xl:px-72 mb-36 animate-fadeinleft sm:animate-fadeinbottom">
            Get an <span className="italic">initial estimate</span> in seconds
            with Finprime consulting{" "}
          </h4>
          ...
          <div className="flex flex-wrap mb-8 animate-fadeinbottom">
            <div className="w-full px-6 border-black sm:animate-fadeinleft lg:w-1/2 sm:px-20 lg:px-0 lg:pl-28 xl:pl-40 lg:pr-24 xl:pr-28 lg:border-r-4">
              <div className="flex justify-between mb-5 ">
                <h4 className="text-2xl font-light lg:text-2xl xl:text-4xl ">
                  Amount
                </h4>
                <div className="text-2xl font-light text-center text-black lg:text-2xl xl:text-4xl">
                  $ {displayPrice(price)}
                </div>
              </div>
              ...
              <div className="relative mb-1 sm:animate-fadeinleft">
                <input
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, #4a5568 0%, #4a5568 " +
              ...
              <div className="flex justify-between pb-8 mt-16 sm:animate-fadeinleft">
                <div>
                  <h3 className="text-2xl font-light lg:text-2xl xl:text-4xl">
                    Duration
                  </h3>
                </div>

                <div className="text-2xl font-light lg:text-2xl xl:text-4xl">
            ...
            <div className="w-full px-6 pt-10 sm:animate-fadeinright lg:w-1/2 sm:px-20 lg:px-0 sm:pt-20 lg:pt-0 lg:pl-24 xl:pl-28 lg:pr-20 xl:pr-40">
              <h4 className="mb-4 text-2xl font-semibold sm:text-4xl lg:text-3xl xl:text-5xl">
                ${(price + 5000).toLocaleString()}
              </h4>
              <h4 className="mb-2 text-xl font-light xl:text-3xl">
                Long heading describing the offer in more detail goes here.
              </h4>
              <p className="mb-4 font-normal lg:text-sm ">
                Long heading describing the offer in more detail Long heading
                describing the offer in more detail goes here.
              </p>
              ...
              <div className="text-xs text-gray-500">
                <p className="mb-12">*Includes 1% in and 1% out fees.</p>
              </div>
