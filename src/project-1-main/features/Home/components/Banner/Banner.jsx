      ...
      <div className="row first-row bg-brandBlue h-[600px] md:h-[500px] lg:h-[700px] flex flex-col md:flex-row justify-between items-center">
        <div className=" pt-8 sm:pt-0 text-left xl:pl-8 sm:pr-6 px-5 sm:px-0 md:pl-4 lg:pl-6 lg:w-[70%]">
          ...
          <p className="mb-8 font-raleway text-sm sm:text-[16px] tracking-[1px] text-white leading-6 font-medium">
            ...
            cross-country operations. A vibrant cross-functional and
            multidisciplinary team headed by a dynamic leadership consistently
            ensures efficient results while a broad reach and expertise make us
            the preferred choice of SMEs and MNCs.
          </p>
          <button
          ...
          >
            <span
              className="border px-4 py-2 sm:px-5 sm:py-3 transition-all duration-300 text-white ease-out
     hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 cursor-pointer hover:text-white"
          ...
          >
            ...
            >
              ...
              >
                <IoIosClose
                  size={28}
                  className="hover:text-brandBlue transition-colors duration-500"
                />
              </button>
              <form onSubmit={handleSubmit} className="space-y-4 z-50">
                <div className="w-[90%] mx-auto">
                  <h5 className="text-white font-khula text-2xl sm:text-4xl font-semibold py-6">
                    Speak to an Expert{" "}
                  </h5>
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-8">
                    ...
                    >
                      ...
                      <span className="text-red-900 font-raleway underline">
                        required
                      </span>
                    </label>
                  </div>
      ...
      <div className="row second-row flex mb-36 lg:mb-0 h-[250px] md:h-[400px] flex-col lg:flex-row items-center justify-between  px-4 md:px-8  ">
        <div className="left-svg pb-6 sm:pb-40 lg:pb-20 lg:pl-5 xl:pl-28">
          <img
            src={imag2}
            alt="Finprime Business & Tax Consultancy"
            className="h-20 sm:h-36 lg:h-48"
          />
        </div>
        <div className="relative middle-section sm:bottom-20 px-5 sm:px-0 md:bottom-28 md:right-0 lg:right-5 xl:right-24 ">
          <img
            ...
            className="center-image h-[220px] md:h-[280px] lg:h-[350px] xl:h-[450px] md:w-[500px] lg:w-full object-cover
           "
          />
        </div>
      </div>
