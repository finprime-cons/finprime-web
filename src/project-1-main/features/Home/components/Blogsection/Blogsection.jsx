  ...
  return (
    <div className="relative pt-6 sm:px-0 overflow-hidden w-full lg:w-[420px] xl:w-[600px] 2xl:w-[700px] mx-auto flex flex-col lg:h-full">
      ...
      <div className="py-4 px-4 relative flex-grow text-left">
        <h3 className="text-black text-xl xl:text-[22px] tracking-[1px] font-semibold font-raleway body pb-4 px-1 lg:px-3">
          {title}
        </h3>
        <div
        ...
        />
        <p className="absolute bottom-6 right-2 pr-2 lg:pr-7 text-md text-gray-600">
          {date}
        </p>
        <Link
          to={`/blogs/${blog_slug}`}
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-8/10 ml-6 mr-4 md:ml-8 md:mr-6 lg:ml-10 lg:mr-8 xl:ml-12 xl:mr-10 bg-pink-50 mt-16 pt-8 pb-8 px-8">
        <h4 className="text-3xl lg:text-4xl font-semibold font-raleway mb-4 md:mb-0">
          Daily Articles
        </h4>
        <Link
          to="/blog"
      ...
      <div className="mt-10 sm:mt-20 ml-6 mr-4 md:ml-8 md:mr-6 lg:ml-10 lg:mr-8 xl:ml-12 xl:mr-10">
        <div className="lg:flex flex-wrap">
          {loading ? (
            ...
            blogs.map((blog) => (
              <div
                className="w-full md:w-full lg:w-1/2 cursor-pointer"
                key={blog.id}
              >
                <BlogCard
                  image={
                  ...
                  description={DOMPurify.sanitize(
                    blog.content.split(/\s+/).slice(0, 30).join(" ")
                  )}
                  id={blog.id}
