    ...
    <div>
      <div className=" mt-72 ">
        <div className="border-b-2 xl:ml-12 xl:mr-10 lg:mr-8 lg:ml-10 md:ml-8 md:mr-6 ml-6 mr-4">
          <h3 className="text-3xl md:text-5xl font-raleway font-medium   pb-4 animate-fadeinright">
            we provide world class best financial Accounting{" "}
          </h3>
          <h3 className="text-md md:text-5xl mb-8  font-medium font-raleway    pb-8 animate-fadeinright">
            and Auditing services in dubai
          </h3>
          <h4 className="mb-8 text-gray-500 text-xs sm:text-[16px] font-raleway font-medium tracking-[1px]">
            CONTACT INFO
          </h4>
          <h4
            className="text-2xl sm:text-5xl mb-4 font-raleway font-medium bg-gradient-to-r from-brandBlue via-cyan-500
               to-cyan-300 bg-clip-text  text-transparent"
          >
            Get in Touch
          </h4>
          <p className="text-gray-500 text-xs sm:text-[16px] tracking-[1px] font-medium mb-2">
            Looking for a dedicated Accountant to take care of your Business. We
          </p>
          <p className="mb-6 text-gray-500 text-xs sm:text-[16px] font-medium tracking-[1px]">
            ensure your data is secure with us. For More details, Talk to our
            expert
          </p>
        </div>
          ...
          <div className="w-full lg:w-5/6 p-4 space-y-4 lg:border-r-2 animate-fadeinbottom">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-3 lg:px-4">
                ...
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                  <CgMail
                    size={22}
                    className="mr-2 bg-white rounded-full shadow-lg py-1 px-1 transition-all duration-300 ease-out 
                hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                ...
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                  <IoIosPhonePortrait
                    size={22}
                    className="mr-2 bg-white rounded-full shadow-md py-1 px-1 transition-all duration-300 ease-out hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                  +971582593543
                </p>
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                  <ImAddressBook
                    ...
                    className="mr-2 bg-white rounded-full shadow-md py-1 px-1 transition-all duration-300 ease-out hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                  12A03, The Executive Bay, Tower B, Business Bay, Dubai, United
                  Arab Emirates
                </p>
              ...
              <div className="space-y-3 lg:px-4">
                ...
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                  <CgMail
                    size={22}
                    className="mr-2 bg-white rounded-full shadow-md py-1 px-1 transition-all
                 duration-300 ease-out hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                  info@finprimeconsulting.com
                </p>
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                ...
                duration-300 ease-out hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                  First Floor, Bluemark Building, Kadavanthra, Kochi, Kerala,
                  India
                </p>
              ...
              <div className="space-y-3 lg:px-4">
                ...
                <p className="flex items-center text-[16px] tracking-[1px] font-medium">
                  <CgMail
                    size={22}
                    className="mr-2 bg-white rounded-full shadow-md py-1 px-1
                ...
                duration-300 ease-out hover:bg-gradient-to-r hover:from-brandBlue hover:to-cyan-500 hover:text-white"
                  />
                  First Floor, Qudaibiya Building, Qudaibiya, Kingdom of Bahrain
                </p>
        ...
        <div className="bg-black pt-10 pb-10 mt-16 ">
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center">
                  ...
                  <label
                    ...
                    className="ml-1 block text-[10px] sm:text-sm
               text-gray-300"
                  >
          ...
          <div className="border-b mx-24 border-gray-600"></div>
        </div>
      </div>
    </div>
  );
