  ...
  return (
    <div className="max-w-full xl:pl-12 xl:pr-10  lg:pl-10 lg:pr-8 md:pl-8 md:pr-6 pl-6 pr-4 mt-28 mb-20">
      <div className="grid px-1 pb-5  ">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold animate-fadeinright ">
          Seven Reasons why{" "}
          <span
            className="bg-gradient-to-r from-brandBlue via-cyan-500
               to-cyan-300 bg-clip-text text-transparent font-semibold"
          >
            ACCOUNTANTS
          </span>
        </h1>
      ...
      <div className="flex justify-left mt-6 ">
        <h2 className="text-md sm:text-2xl font-semibold uppercase animate-fadeinleft">
          An Accounts
        </h2>
      </div>
      ...
      >
        {images.map((image) => (
          <div key={image.id} className="relative group">
            ...
            />
            <div
              className="absolute bottom-10 w-[90%] mx-3 md:mx-2.5 xl:mx-4 transition-all duration-300
             ease-out group-hover:bg-gradient-to-r group-hover:from-brandBlue hover:to-cyan-500 
             text-white p-2 text-center"
            >
              <h3 className=" font-semibold text-md lg:text-lg xl:text-lg text-shadow-md">
                {image.title}
              </h3>
            </div>
          </div>
