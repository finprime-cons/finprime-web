...
const Btext = () => {
  ...
  return (
    <div
      ref={fadeElementRef}
      className={`xl:pl-12 xl:pr-10 lg:pl-10 lg:pr-8 py-1 md:pr-6 md:pl-8  pl-6 pr-4 ${
        hasFadedIn ? "animate-fadeinbottom" : ""
      }`}
    >
      <h4 className="text-5xl sm:text-7xl font-medium mb-6 sm:mb-4 mt-20">
        Social Feeds{" "}
      </h4>

      <p className="mb-6   text-[12px] sm:text-[16px] tracking-[1px]  font-raleway">
        This is a long paragraph related to the blog content. Here, you can
        discuss the blog topic in detail, providing insights, opinions, or any
        relevant information that engages your readers. Make sure to cover the
        key points and maintain a friendly tone to keep your audience
        interested.
      </p>
      ...
      <div className="flex justify-between items-center mt-12">
        <div>
          <h4 className="text-[12px] sm:text-[22px] font-semibold font-raleway tracking-[1px]">
            Browse All
          </h4>
        </div>

        <div className="text-right text-[12px] sm:text-base flex gap-4"></div>
      </div>
